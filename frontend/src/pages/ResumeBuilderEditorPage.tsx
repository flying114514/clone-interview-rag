...
import { MinimalResumeLayout, TechnicalResumeLayout, buildProfile } from '../components/ResumeTemplateLayouts';
import { CreativeResumeLayout, ManagementResumeLayout } from '../components/ResumeTemplateLayoutsExtra';
